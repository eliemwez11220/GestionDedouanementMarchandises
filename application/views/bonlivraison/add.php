    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Bonlivraison Add</h3>
            </div>
            <?php echo form_open('bonlivraison/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="numBon" value="<?php echo $this->input->post('numBon'); ?>" class="form-control" id="numBon" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="dateBon" value="<?php echo $this->input->post('dateBon'); ?>" class="has-datepicker form-control" id="dateBon" />
						</div>
					</div>
					<div class="col-md-6">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="dateDedouane" value="<?php echo $this->input->post('dateDedouane'); ?>" class="has-datepicker form-control" id="dateDedouane" />
						</div>
					</div>
					<div class="col-md-6">
