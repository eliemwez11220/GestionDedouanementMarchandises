    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Marchandise Edit</h3>
            </div>
			<?php echo form_open('marchandise/edit/'.$marchandise['mar_id']); ?>
			<div class="box-body">
				<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="client_sid" class="form-control">
								...
								{
									$selected = ($demandeclient['dem_id'] == $marchandise['client_sid']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="cotation_sid" class="form-control">
								...
								{
									$selected = ($value == $marchandise['cotation_sid']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="bonLivraison_sid" class="form-control">
								...
								{
									$selected = ($bonlivraison['bon_id'] == $marchandise['bonLivraison_sid']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="designation" value="<?php echo ($this->input->post('designation') ? $this->input->post('designation') : $marchandise['designation']); ?>" class="form-control" id="designation" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="quantite" value="<?php echo ($this->input->post('quantite') ? $this->input->post('quantite') : $marchandise['quantite']); ?>" class="form-control" id="quantite" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="poids" class="control-label">Poids</label>
						<div class="form-group">
							<input type="text" name="poids" value="<?php echo ($this->input->post('poids') ? $this->input->post('poids') : $marchandise['poids']); ?>" class="form-control" id="poids" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="volume" class="control-label">Volume</label>
						<div class="form-group">
							<input type="text" name="volume" value="<?php echo ($this->input->post('volume') ? $this->input->post('volume') : $marchandise['volume']); ?>" class="form-control" id="volume" />
						</div>
					</div>
				</div>
			</div>
